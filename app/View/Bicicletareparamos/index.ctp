<?php echo $this->Html->script(array('/js/bicicletareparamos/index.js','jquery.maskedinput','jquery.toastmessage'),array('block'=>'scriptjs'));?>
...
<div class="panel panel-ingresos">
	<div class="panel-heading">
		<i class="fa fa-clock-o fa-fw"></i><?php echo __('Ingresos en Taller')?>
    </div>
    <!-- /.panel-heading -->
