<?php echo $this->element('modalboxcabecera',array('title'=>__('Información Detallada del Cliente'),'paneltipo'=>'panel-primary'));?>
<div class="" style="padding-top: 10px;padding-left: 10px;padding-bottom: 10px;padding-right: 10px;">
		<div class="row">
			<div class="col-lg-5">
				<div class="row">
					<div class="col-lg-6">
