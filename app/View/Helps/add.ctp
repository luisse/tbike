		<?php echo $this->Html->script(array('/js/helps/add.js','fmensajes.js','fgenerales.js','jquery.toastmessage','yellow-text'),array('block'=>'scriptjs')); ?>
		<?php echo $this->Html->css(array('message','yellow-text-blue'), null, array('inline' => false))?>
		<?php echo $this->element('flash_message')?>
		<?php echo $this->Form->create('Help',array('action'=>'add',	
				'inputDefaults' => array(
							'div' => 'form-group',
							'wrapInput' => false,
							'class' => 'form-control'
				...
				'class' => 'well'));?>
<fieldset>
	<legend>		<?php echo __('Nueva Ayuda') ?></legend>
