<?php echo $this->Html->script(array('/js/mensajesmantenimientos/indexmant.js','fgenerales','dateformat.js','bootstrap-datetimepicker','jquery.toastmessage'),array('block'=>'scriptjs'));?>
<?php echo $this->Html->css(array('message','bootstrap-datetimepicker'), null, array('inline' => false))?>		
<?php echo $this->element('flash_message')?>
<script>
	var link="<?php echo $this->Html->url(array('controller'=>'mensajesmantenimientos','action'=>'listmensajes')) ?>"
</script>
					...
					<div class="row">	
						<div class="col-lg-2">		
							...
							<div class="form-group">
								...
								<?php echo $this->Form->input('Mensajesmantenimiento.fecdesde',array('label' =>false,
													'placeholder' => false,
						...
						<div class="col-lg-2">			
							...
							<div class="form-group">
									<div class='input-group date' id='datetimepicker1' data-date-format="DD/MM/YYYY">
									<?php echo $this->Form->input('Mensajesmantenimiento.fechasta',array('label' =>false,
													'placeholder' => false,
													'class'=>'form-control input-sm',
													'type'=>'text',
													'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?>
						...
						<div class="col-lg-4">								
							<?php echo $this->Form->input('Mensajesmantenimiento.observaciones',array(
