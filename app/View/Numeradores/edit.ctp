<?php		echo $this->Html->script('fmensajes.js');
	...
	array('js_funcionalidad' => '/js/numeradores/Numeradore_edit.js',
			'label_modelo' =>'Numeradore',
			'label_detalle'=>'Nuevo Numeradore',
			'label_caja'=>'Detalles del Numeradore',
			'controlador'=>'numeradores'))?><?php echo $this->Form->create('Numeradore',array('action'=>'edit'));?>
