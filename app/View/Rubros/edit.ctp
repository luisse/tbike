<?php	echo $this->Html->script(array('/js/rubros/edit.js','fmensajes.js','fgenerales.js','jquery.numeric','jquery.toastmessage'),array('block'=>'scriptjs'));	?>
<?php 
...
<?php echo $this->Form->create('Rubro',array('action'=>'edit',	
				'inputDefaults' => array(
									'div' => 'form-group',
									'wrapInput' => false,
									'class' => 'form-control'
...
<fieldset>
	<legend><?php echo __('Actualizar Rubro') ?></legend>
	<div class="row">
			<div class="col-lg-10">
...
<div class="row">	
	<div class="col-xs-6 col-sm-6">
		...
		<button type="button" class="btn btn-success btn-lw" id='guardar'>
		  <span class="glyphicon glyphicon glyphicon-save"></span>&nbsp;<?php echo __('Actualizar') ?>
		</button>	
		</center>
	</div>
	<div class="col-xs-6 col-sm-6">
