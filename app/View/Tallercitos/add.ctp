<?php			
		echo $this->Html->script(array('/js/tallercitos/add.js','fgenerales','fmensajes.js','jquery.maskedinput','jquery.numeric'),array('block'=>'scriptjs'));?>

<?php echo $this->Form->create('Tallercito',array('action'=>'add',	
		'inputDefaults' => array(
							'div' => 'form-group',
							'wrapInput' => false,
							'class' => 'form-control'
