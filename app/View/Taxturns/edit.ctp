...
<?php echo $this->Form->create('Taxturn'); ?>
	<fieldset>
		<legend><?php echo __('Edit Taxturn'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Taxturn.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Taxturn.id'))); ?></li>
