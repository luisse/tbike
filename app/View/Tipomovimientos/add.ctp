<?php		
	echo $this->Html->script(array('/js/tipomovimientos/add.js','fmensajes.js','fgenerales.js','jquery.numeric'),array('block'=>'scriptjs'));		?>

			
<?php echo $this->Form->create('Tipomovimiento',array('action'=>'add',	
				'inputDefaults' => array(
									'div' => 'form-group',
									'wrapInput' => false,
									'class' => 'form-control'
