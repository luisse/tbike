<?php	echo $this->Html->script('/js/users/cambiarcontrasenia.js',array('block'=>'scriptjs'));?>
...
<fieldset>
	<legend><?php echo __('Cambiar Contraseña del Usuario')?></legend>
	...
	<?php echo $this->Form->hidden('User.cambiarcontrasenia',array('value'=>'1'))?>
	<fieldset>
		<div class='row'>
			<div class='col-lg-5'>
