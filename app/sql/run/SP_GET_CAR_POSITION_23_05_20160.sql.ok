...
-- DROP FUNCTION public.sp_get_car_for_position_v2(double precision, double precision, integer, integer);

CREATE OR REPLACE FUNCTION public.sp_get_car_for_position_v2(IN p_lat double precision, IN p_lng double precision, IN max_ratio_km integer, IN radiotaxi_id integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.sp_get_car_for_position_v2(double precision, double precision, integer, integer)
  OWNER TO postgres;
