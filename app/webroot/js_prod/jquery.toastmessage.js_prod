(function($)
{var settings={inEffect:{opacity:'show'},inEffectDuration:600,stayTime:3000,text:'',sticky:!1,type:'notice',position:'top-right',closeText:'',close:null};var methods={init:function(options)
